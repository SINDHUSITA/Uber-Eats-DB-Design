...
Instructions:
You are working for Uber Eats. Your manager tasks you with designing a new database
for keeping track of its service. Given the following information, draw the ER diagram:
